...
func CreateAndSignAppPackage(ctx android.ModuleContext, outputFile android.WritablePath,
	packageFile, jniJarFile, dexJarFile android.Path, certificates []Certificate, deps android.Paths, v4SignatureFile android.WritablePath, micaFile android.Path, rotationMinSdkVersion string) {
	...
	SignAppPackage(ctx, outputFile, unsignedApk, certificates, v4SignatureFile, micaFile, rotationMinSdkVersion)
}

func SignAppPackage(ctx android.ModuleContext, signedApk android.WritablePath, unsignedApk android.Path, certificates []Certificate, v4SignatureFile android.WritablePath, micaFile android.Path, rotationMinSdkVersion string) {
	...
	if micaFile != nil {
		flags = append(flags, "--mica", micaFile.String())
		deps = append(deps, micaFile)
	}
